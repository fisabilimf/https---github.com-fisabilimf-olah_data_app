...
<head>
    ...
    <script src="{{ url('https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.0/xlsx.full.min.js') }}"></script>
    <script src="{{ url('https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.3.0/papaparse.min.js') }}"></script>    
...
<body>
    ...
    <form method="post" action="{{ url('/') }}">
        ...
        <div class="flex-item">
            <h2>Nilai Kn untuk uji inlier-outlier</h2>
            <table>
                <thead>
                    <tr>
                        <th>Jumlah data</th>
                ...
                <tbody>
                    <tr>
                        <td><input type="text" name="jumlah_data_10" value="10" readonly></td>
                        <td><input type="text" name="kn_10" value="2.036" readonly></td>
                        <td><input type="text" name="jumlah_data_24" value="24" readonly></td>
                        <td><input type="text" name="kn_24" value="2.467" readonly></td>
                        <td><input type="text" name="jumlah_data_38" value="38" readonly></td>
                        <td><input type="text" name="kn_38" value="2.661" readonly></td>
                        <td><input type="text" name="jumlah_data_60" value="60" readonly></td>
                        <td><input type="text" name="kn_60" value="2.837" readonly></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="jumlah_data_11" value="11" readonly></td>
                        <td><input type="text" name="kn_11" value="2.088" readonly></td>
                        <td><input type="text" name="jumlah_data_25" value="25" readonly></td>
                        <td><input type="text" name="kn_25" value="2.468" readonly></td>
                        <td><input type="text" name="jumlah_data_39" value="39" readonly></td>
                        <td><input type="text" name="kn_39" value="2.671" readonly></td>
                        <td><input type="text" name="jumlah_data_65" value="65" readonly></td>
                        <td><input type="text" name="kn_65" value="2.866" readonly></td>
                    </tr>
                    <tr>
                        <td><input type="text" name="jumlah_data_12" value="12" readonly></td>
                        <td><input type="text" name="kn_12" value="2.134" readonly></td>
                        <td><input type="text" name="jumlah_data_26" value="26" readonly></td>
                        <td><input type="text" name="kn_26" value="2.502" readonly></td>
                        <td><input type="text" name="jumlah_data_40" value="40" readonly></td>
                        <td><input type="text" name="kn_40" value="2.682" readonly></td>
                        <td><input type="text" name="jumlah_data_70" value="70" readonly></td>
                        <td><input type="text" name="kn_70" value="2.893" readonly></td>
                    </tr>
                    <!-- Continue similarly for all remaining rows -->
                    <!-- Below is an example of another row -->
                    <tr>
                        <td><input type="text" name="jumlah_data_13" value="13" readonly></td>
                        <td><input type="text" name="kn_13" value="2.175" readonly></td>
                        <td><input type="text" name="jumlah_data_27" value="27" readonly></td>
                        <td><input type="text" name="kn_27" value="2.519" readonly></td>
                        <td><input type="text" name="jumlah_data_41" value="41" readonly></td>
                        <td><input type="text" name="kn_41" value="2.692" readonly></td>
                        <td><input type="text" name="jumlah_data_75" value="75" readonly></td>
                        <td><input type="text" name="kn_75" value="2.917" readonly></td>
                    </tr>
                    <!-- Continue with the rest of the table data -->
                </tbody>
            </table>
            <p>Departemen Pekerjaan Umum, Panduan perencanaan Bendungan Urugan Volume II, 1999</p>
        </div>
